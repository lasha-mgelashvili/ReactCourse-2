...
function Card(data) {
  return React.createElement("div", { className: "shopping-item" }, [
    React.createElement("h1", null, [data.firstname]),
    React.createElement("h2", null, [data.lastname]),
    React.createElement("h3", null, [data.email]),
    React.createElement("h3", null, [data.gender]),
    React.createElement("h2", null, [data.age]),
    React.createElement("h2", null, [data.job]),
  ]);
}
